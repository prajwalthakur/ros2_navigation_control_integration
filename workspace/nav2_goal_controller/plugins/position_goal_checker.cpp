...
#include <string>
#include <limits>
#include "nav2_goal_controller/plugins/position_goal_checker.hpp"
...
void nav2_goal_controller::PositionGoalChecker::setXYGoalTolerance(double tolerance)
{
...
PLUGINLIB_EXPORT_CLASS(nav2_goal_controller::PositionGoalChecker, nav2_core::GoalChecker)
