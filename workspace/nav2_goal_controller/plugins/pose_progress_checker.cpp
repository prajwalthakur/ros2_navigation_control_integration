...
#include "nav2_goal_controller/plugins/pose_progress_checker.hpp"
#include <cmath>
#include <string>
#include <memory>
#include <vector>
...
PLUGINLIB_EXPORT_CLASS(nav2_goal_controller::PoseProgressChecker, nav2_core::ProgressChecker)
